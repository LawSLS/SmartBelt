...
let produitsSansErreur = productsWithoutError(products);
...
btn_tri.addEventListener("click", function () {
  console.log("coucou");
  produitsSansErreur.sort((prix_indice_actuel, prix_indice_plus_un) => {
    console.log("coucou2");
